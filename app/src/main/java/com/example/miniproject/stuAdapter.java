...
public class stuAdapter extends RecyclerView.Adapter<stuAdapter.ContactViewHolder> {

    private final Context context;
    private final ArrayList<stumodel> contactList;


    public stuAdapter(Context context, ArrayList<stumodel> contactList) {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        stumodel modelContact = contactList.get(position);
        ...
        holder.relativeLayout.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(context,stucontact.class);
